...
class ServiceController extends Controller
{
    ...
    {
        return view('administrator.service_page.index');
    }

    public function add()
    {
        $language = Language::get();
        return view('administrator.service_page.add', compact('language'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('administrator.service_page.edit', compact('service', 'serviceContent', 'languages'));
    }
