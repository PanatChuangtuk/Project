...
class AddressController extends MainController
{
    ...
    public function edit($lang, $id)
    {
        ...
        return view('cart-address-detail', compact('address', 'provinces', 'districts', 'subdistricts', 'url'));
    }
    public function cartAddress()
    {
        ...
        $subdistricts = DB::table('tambons')
            ->select('id', 'zip_code', 'name_th', 'name_en', 'amphure_id')
            ->get();
        return view('cart-address', compact('profile', 'provinces', 'districts', 'subdistricts', 'url'));
    }
    public function submit(Request $request)
    {
        ...
        if (route('profile.address', ['lang' => app()->getLocale()]) !== $request->input('url')) {
            return redirect($request->input('url'));
        }
        return redirect()->route('profile.address', ['lang' => app()->getLocale()]);
    }
