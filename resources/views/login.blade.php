                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="title mb-0"><a
                                                href="otp-forgot-password.html">@lang('messages.forgot_password')</a></label>
                                        <label class="title mb-0"><a href="index-guest.html">@lang('messages.return_to_store')</a></label>
                                    </div>
                                </div>
