...
@section('content') 
<form id="myForm" action="{{ route('administrator.banner.submit') }}" method="POST" enctype="multipart/form-data" class="container">
    @csrf
    ...
    <div class="card p-4">
        ...
        <div class="mb-4 row">
            ...
            <div class="col-md-10">
                <textarea  class="form-control" id="url" name="url" placeholder="Enter URL"></textarea>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $("#image").fileinput({
            uploadUrl: "{{ route('administrator.banner.submit') }}",
            showRemove: false,
