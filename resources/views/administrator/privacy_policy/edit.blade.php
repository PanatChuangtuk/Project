...
@section('content') 
<form id="myForm" action="{{ route('administrator.privacy.update', $news->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<script>
    $(document).ready(function() {
        $("#image").fileinput({
            uploadUrl: "{{ route('administrator.privacy.update', $news->id) }}",
            deleteUrl: "{{ route('administrator.privacy.delete.image', $news->id).'?_token='.csrf_token() }}",
