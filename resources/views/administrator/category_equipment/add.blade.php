...
@section('content')
    <ol class="breadcrumb bg-light p-3 rounded shadow-sm">
        ...
        <li class="breadcrumb-item"><a href="{{ route('administrator.category-equipment') }}">หมวดหมู่อุปกรณ์</a></li>
        <li class="breadcrumb-item active" aria-current="page">เพิ่มหมวดหมู่อุปกรณ์</li>
    </ol>

    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-header text-white rounded-top-4">
            <h5 class="mb-0"><i class="fas fa-user-plus"></i> เพิ่มหมวดหมู่อุปกรณ์</h5>
        </div>
        <div class="card-body">
            <form id="form-create" method="POST" action="{{ route('administrator.category-equipment.submit') }}"
                ...
                <div class="row g-4">
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type_id[]" id="typeSelect" class="form-control" multiple>
                                <option value="">ชนิดอุปกรณ์</option>
                            </select>
                            @error('type_id')
