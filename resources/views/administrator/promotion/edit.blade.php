                    ...
                    @foreach ($languages as $index => $language)
                        <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="tab-{{ $language->code }}" role="tabpanel">
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" value="{{ $promotionContents[$language->id]->name ?? '' }}" id="name-{{ $language->id }}" name="name[{{ $language->id }}]" />
                                </div>
                            </div>
                            <div class="mb-4 row">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-10">
                                    <textarea name="content[{{ $language->id }}]" class="areaEditor form-control" cols="30" rows="5" id="content-{{ $language->id }}">{{ $promotionContents[$language->id]->content ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
