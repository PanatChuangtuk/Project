...
<form id="myForm" action="{{ route('administrator.testimonial.submit') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="tab-{{ $languages->code }}" role="tabpanel">
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" placeholder="Input Name" id="name" name="name[{{ $languages->id}}]"/>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" placeholder="Input Position" id="positon" name="positon_name[{{ $languages->id}}]"/>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" id="description" style="height:221px" name="description[{{$languages->id}}]"></textarea>
                        </div>
                    </div>
                </div>
                @endforeach  
...
<script>
    $(document).ready(function() {
        $("#image").fileinput({
            uploadUrl: "{{ route('administrator.testimonial.submit') }}",
            showRemove: false,
