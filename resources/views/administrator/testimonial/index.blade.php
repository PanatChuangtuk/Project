                            ...
                            <tbody class="table-border-bottom-0" id="testimonialTableBody">
                                @foreach ($testimonial as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->image)
                                                <img src="{{ asset('upload/file/banner/' . $item->image) }}" alt="{{ $item->image }}" class="img-thumbnail w-px-50 h-px-50" />
                                            @else
                                                <img src="https://via.placeholder.com/50" alt="Placeholder Image" class="img-thumbnail w-px-50 h-px-50" />
                                            @endif
                                        </td> 
                                        <td>{{ $item->name }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0" href="{{ route('administrator.testimonial.edit',['id' => $item->id]) }}">
