...
<form id="myForm" action="{{ route('administrator.service.submit') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="tab-{{ $languages->code }}" role="tabpanel">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="col-md-10">
                            <textarea name="description[{{ $languages->id }}]" class="areaEditor form-control" cols="30" rows="5" id="description-{{ $languages->id }}"></textarea>
                        </div>
                    </div>
                </div>
                @endforeach  
...
<script>
    $(document).ready(function() {
        $("#image").fileinput({
            uploadUrl: "{{ route('administrator.service.submit') }}",
            showRemove: false,
