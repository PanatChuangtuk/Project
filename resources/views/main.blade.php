                ...
                <div class="container">
                            ...
                            <div class="member-links member dropdown">
                                <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        {{-- <li><a href="my-purchase.html">My Purchase</a></li> --}}
                                        <li>
                                            <a href="#" class="logout"
                                            ...
                                            <form id="logout-form"
                                                action="{{ route('logout', ['lang' => app()->getLocale()]) }}"
                    ...
                    <ul class="nav nav-general right">
                        ...
                        <li class="d-desktop-none">
                            <a class="btn btn-outline" href="cart">
                        ...
                        <li class="dropdown d-desktop-none">
                            ...
                            <ul class="dropdown-menu right" style="--width:96px">
                                <li><a href="login">@lang('messages.login')</a></li>
                                <li><a href="register">@lang('messages.search')</a></li>
                            </ul>
                        </li>
            ...
            <ul class="nav nav-accordion">
                ...
                <li>
                    <h5 data-bs-toggle="collapse" data-bs-target="#product-sub"><a
                            href="#">@lang('messages.products')</a></h5>
