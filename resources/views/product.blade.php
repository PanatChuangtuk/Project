                    ...
                    <div class="col-4">
                        ...
                        <div class="card-category" data-bs-toggle="tab" data-bs-target="#tab-category-{{ $loop->index }}">
                            ...
                            <div class="card-body">
                                ...
                                <p class="d-flex">
                                    <a class="viewmore"
                                        href="{{ url(app()->getLocale() . '/product-list/' . $item->id) }}">ดูเพิ่มเติม</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tab-category-{{ $loop->index }}" class="tab-pane">
                        ...
                        <div class="row logo-brand-lists">
                            @foreach ($product_model as $model)
                                @if ($model->product_type_id === $item->id)
                                    <div class="col-2">
                                        <ul class="ul-collapse">
                                            <li><a
                                                    href="{{ url(app()->getLocale() . '/product-list/') }}">{{ $model->name }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                @endif
                            ...
                            @foreach ($product_category as $category)
                                @if ($category->product_type_id === $item->id)
                                    <div class="col-2">
                                        <ul class="ul-collapse">
                                            <li><a
                                                    href="{{ url(app()->getLocale() . '/product-list/') }}">{{ $category->name }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                @endif
